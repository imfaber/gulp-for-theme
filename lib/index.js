...
function gulpify() {
  co(function *() {
    ...
    console.log('---------------------------------------------');
    console.log();
    console.log('You are nearly done. You just need to go through the following:');
    console.log();
    console.log('1. Install node modules');
    console.log('$ ' + chalk.gray.bold('npm install'));
    console.log();
    console.log('2. Adjust your configuration at ' + path.resolve(config.paths.themeAbsolute, 'gulpfile/config.js'));
    console.log();
    console.log('3. Run gulp');
